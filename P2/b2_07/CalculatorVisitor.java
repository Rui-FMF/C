...
public interface CalculatorVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code ProcessExpr}
	 * labeled alternative in {@link CalculatorParser#stat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProcessExpr(CalculatorParser.ProcessExprContext ctx);
	/**
	 * Visit a parse tree produced by the {@code ProcessAssignment}
	 * labeled alternative in {@link CalculatorParser#stat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProcessAssignment(CalculatorParser.ProcessAssignmentContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitUnaryPlus(CalculatorParser.UnaryPlusContext ctx);
	/**
